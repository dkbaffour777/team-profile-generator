            ...
            .prompt([
                {
                    ...
                    validate: officeNumber => {
                        if (officeNumber) {
                            ...
                            console.log(`Please fill out the Manager\'s office number!`);
                            return false;
                        }
                    }
                },
            ...
            .prompt([
                {
                    ...
                    validate: name => {
                        if (name) {
                            ...
                            console.log(`Please fill out the ${role}\'s name!`);
                            return false;
                        }
                    }
                },
                {
                    ...
                    validate: id => {
                        if (id) {
                            ...
                            console.log(`Please fill out the ${role}\'s ID!`);
                            return false;
                        }
                    }
                },
                {
                    ...
                    validate: email => {
                        if (email) {
                            ...
                            console.log(`Please fill out the ${role}\'s email!`);
                            return false;
                        }
                    }
                },
                ...
                .prompt([
                    {
                        ...
                        validate: github => {
                            if (github) {
                                ...
                                console.log(`Please fill out the engineer\'s github`);
                                return false;
                            }
                        }
                    },
                ...
                .prompt([
                    {
                        ...
                        validate: school => {
                            if (school) {
                                ...
                                console.log(`Please fill out the intern\'s school`);
                                return false;
                            }
                        }
                    },
